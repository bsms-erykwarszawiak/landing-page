...
const GoldPackage = () => {
  return (
    ...
    <p className="flex text-3xl font-main text-[#E7E7E7] ">Sklep internetowy</p>
    ...
    <div className="flex flex-col w-full items-start justify-center">
      ...
      <div className="flex flex-row w-full h-content ml-4 my-3">
        <Image src="/assets/check.svg" width={25} height={25} alt="Check" />
        <p className="ml-4 font-main text-[#E7E7E7]">Zabezpieczenia zakupów SSL</p>
      </div>
      <div className="flex flex-row w-full h-content ml-4 my-3">
        <Image src="/assets/check.svg" width={25} height={25} alt="Check" />
        <p className="ml-4 font-main text-[#E7E7E7]">Wgranie produktów na stronę 100szt. GRATIS</p>
      </div>
    </div>
